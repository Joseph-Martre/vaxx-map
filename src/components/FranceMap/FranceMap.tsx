...
const InnerMap = memo(() => (
  ...
  <div id="map">
    <svg
      ...
      xml:space="preserve"
    >
      <a target="_blank" xlink:href="region01.html">
        <g
          className="region region-01"
          data-nom="Guadeloupe"
          data-code_insee="01"
        >
          <path
      ...
      <a target="_blank" xlink:href="region-02.html">
        <g
          className="region region-02"
          data-nom="Martinique"
          data-code_insee="02"
        >
          <path
      ...
      <a target="_blank" xlink:href="region-03.html">
        <g className="region region-03" data-nom="Guyane" data-code_insee="03">
          <path
            data-nom="Guyane"
      ...
      <a target="_blank" xlink:href="region-04.html">
        <g
      ...
      <a target="_blank" xlink:href="region-06.html">
        <g className="region region-06" data-nom="Mayotte" data-code_insee="06">
          <path
            data-nom="Mayotte"
      ...
      <a target="_blank" xlink:href="region-11.html">
        <g
      ...
      <a target="_blank" xlink:href="region-24.html">
        <g
      ...
      <a target="_blank" xlink:href="region-27.html">
        <g
      ...
      <a target="_blank" xlink:href="region-28.html">
        <g
      ...
      <a target="_blank" xlink:href="region-32.html">
        <g
      ...
      <a target="_blank" xlink:href="region-44.html">
        <g
      ...
      <a target="_blank" xlink:href="region-52.html">
        <g
      ...
      <a target="_blank" xlink:href="region-53.html">
        <g
      ...
      <a target="_blank" xlink:href="region-75.html">
        <g
      ...
      <a target="_blank" xlink:href="region-76.html">
        <g
      ...
      <a target="_blank" xlink:href="region-84.html">
        <g
      ...
      <a target="_blank" xlink:href="region-93.html">
        <g
      ...
      <a target="_blank" xlink:href="page-10.html">
...
type FranceMapProps = {
  onDepartmentClick: (e: MouseEvent) => void;
  highlightedDepartments: Set<string>;
  greyedOutDepartments: Set<string>;
};

export const FranceMap = memo(
  ({
    onDepartmentClick,
    highlightedDepartments,
    greyedOutDepartments,
  }: FranceMapProps) => {
    const departmentSVGRef = useRef<NodeListOf<SVGPathElement>>(null);

    // populate ref on mount
    useEffect(() => {
      departmentSVGRef.current = document.querySelectorAll<SVGPathElement>(
        "#map path[data-numerodepartement]"
      );
    }, []);

    // mount the click handlers
    useEffect(() => {
      departmentSVGRef.current?.forEach(
        (path) => (path.onclick = onDepartmentClick)
      );
    }, [onDepartmentClick]);

    // toggle highlight
    useEffect(() => {
      departmentSVGRef.current?.forEach((path) => {
        const departmentNumber = path.dataset.numerodepartement;
        if (!departmentNumber) return;
        if (highlightedDepartments.has(departmentNumber)) {
    ...
    useEffect(() => {
      departmentSVGRef.current?.forEach((path) => {
        const departmentNumber = path.dataset.numerodepartement;
        if (!departmentNumber) return;
        if (greyedOutDepartments.has(departmentNumber)) {
          path.classList.add("greyed-out");
        } else {
          path.classList.remove("greyed-out");
        }
      });
    }, [greyedOutDepartments]);
